...
export default function ReportDetailPage() {
    ...
    // Ambil user (untuk role, tapi tidak pakai LayoutUI)
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                // Fetch report (TIDAK ADA FILTER USER, admin bisa lihat semua)
                ...
                // Fetch user email berdasarkan user_id
                let user_email = "-";
                if (reportData.user_id) {
                    console.log(
                        "Fetching user email for user_id:",
                        reportData.user_id
                    ...
                    if (userError) {
                        ...
                        console.log("User data:", userData); // Tambah log untuk debug
                        user_email = userData?.email ?? "-";
                    }
                } else {
                    console.log("No user_id in reportData"); // Tambah log jika user_id null
                }
